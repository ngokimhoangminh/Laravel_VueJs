...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    loadBrand: function () {
      var _loadBrand = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
        var _this = this;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                Object(_helpers_apiRequest__WEBPACK_IMPORTED_MODULE_3__["apiRequest"])('/api/brand/brands' + Object(_helpers_buildUrl__WEBPACK_IMPORTED_MODULE_4__["buildUrl"])(this.params)).then(function (res) {
                  var m = res;
      ...
      function loadBrand() {
        return _loadBrand.apply(this, arguments);
      }
    ...
    EditBrand: function EditBrand(brand) {
      this.edit = true;
      this.visibleShow = true;
      this.brandData.id = brand.id;
      this.brandData.name = brand.name;
      this.brandData.description = brand.description;
      this.brandData.status = brand.status;
    },
    ...
    saveBrand: function () {
      var _saveBrand = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2() {
        var _this2 = this;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 25:
                ...
                _context2.prev = 26;
                _context2.next = 29;
                return _services_brands_service__WEBPACK_IMPORTED_MODULE_1__["updateBrand"](this.brandData.id, brand);

              case 29:
                _response = _context2.sent;
                this.brands.map(function (brand) {
                  if (brand.id == _response.data.id) {
                    for (var key in _response.data) {
                      brand[key] = _response.data[key];
                    }
                  }
                });
                this.flashMessage.success({
        ...
        }, _callee2, this, [[5, 15], [26, 36]]);
      }));

      function saveBrand() {
        return _saveBrand.apply(this, arguments);
      }

      return saveBrand;
    }(),
    Remove: function () {
      var _Remove = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee3(brand) {
        var response;
    ...
    unactive: function () {
      var _unactive = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee4(id) {
        var formData;
      ...
      function unactive(_x2) {
        return _unactive.apply(this, arguments);
      }

      return unactive;
    }(),
    active: function () {
      var _active = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee5(id) {
        var formData;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                formData.append('brand_id', id);
                _context5.next = 5;
                return _services_brands_service__WEBPACK_IMPORTED_MODULE_1__["active"](formData);
        ...
        [
          _c(
            ...
            [
                        ...
                        scope.row.status == 1
                          ...
                          : _c(
                              "el-button",
                              {
                                ...
                                on: {
                                  click: function($event) {
                                    return _vm.active(scope.row.id)
                                  }
                                }
                              },
                              [_vm._v("Ẩn")]
              ...
              _vm._v(" "),
              _c("el-table-column", {
                attrs: { fixed: "right", align: "right", width: "170" },
                scopedSlots: _vm._u([
                  {
                    key: "header",
                    fn: function(scope) {
...
/*!*******************************************************!*\
  !*** ./resources/js/admin/services/brands_service.js ***!
  \*******************************************************/
/*! exports provided: createBrand, loadeBrand, deleteBrand, updateBrand, unactive, active */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
